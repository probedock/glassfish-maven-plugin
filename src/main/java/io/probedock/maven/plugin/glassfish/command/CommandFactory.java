...
import static io.probedock.maven.plugin.glassfish.command.CommandName.*;
import static io.probedock.maven.plugin.glassfish.command.argument.CommandArgumentFactory.*;
import static io.probedock.maven.plugin.glassfish.command.argument.CommandArgumentName.*;
